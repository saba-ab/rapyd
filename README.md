...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/rapyd.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/rapyd)
...
```bash
php artisan vendor:publish --tag="rapyd-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="rapyd-views"
```

## Usage

```php
$rapyd = new Sabaab\Rapyd();
echo $rapyd->echoPhrase('Hello, Sabaab!');
```
